...
No. Tarmhack'AI makes no AI API calls of its own. Its AI features drive the Claude Code CLI
already installed on your machine, using **your own** authentication. No extra key, no extra
AI subscription.
